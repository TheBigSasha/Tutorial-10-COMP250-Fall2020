...
public class PocketMonster implements Comparable<PocketMonster>{
    ...
    public int compareTo(PocketMonster o) {
        int scoreOfThis = this.getDamage() * this.getHp();
        int scoreOfOther = o.getDamage() * o.getHp();
        return scoreOfThis - scoreOfOther;
    }

    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("PocketMonster{");
